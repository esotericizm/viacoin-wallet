...
import com.viacoin.wallet.ui.RequestCoinsActivity;
import com.viacoin.wallet.ui.SendCoinsQrActivity;
import com.viacoin.wallet.ui.WalletActivity;
import com.viacoin.wallet.ui.send.SendCoinsActivity;
import com.viacoin.wallet.util.GenericUtils;
...
public class WalletBalanceWidgetProvider extends AppWidgetProvider
{
			...
			final Bundle appWidgetOptions, final Coin balance)
	{
		...
		if (appWidgetOptions != null)
		{
			...
			views.setViewVisibility(R.id.widget_via_icon, minWidth > 400 ? View.VISIBLE : View.GONE);
