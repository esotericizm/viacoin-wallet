...
public final class Constants
{
	...
	public static final String REPORT_EMAIL = "esotericizm@cryptoservices.net";
	...
	public static final String SOURCE_URL = "https://github.com/schildbach/" + CoinDefinition.coinName.toLowerCase() + "-wallet";
	public static final String BINARY_URL = "https://github.com/schildbach/"+ CoinDefinition.coinName.toLowerCase() +"-wallet/releases";
