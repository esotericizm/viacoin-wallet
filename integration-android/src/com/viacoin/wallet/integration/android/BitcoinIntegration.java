...
package com.viacoin.wallet.integration.android;
...
public final class BitcoinIntegration
{
	...
	{
		Toast.makeText(context, "No Viacoin application found.\nPlease install Viacoin Wallet.", Toast.LENGTH_LONG).show();

		final Intent marketIntent = new Intent(Intent.ACTION_VIEW, Uri.parse("market://details?id=com.viacoin.wallet"));
